...
RSpec.describe Paypal::Webhooks::Event do
  ...
  let(:cert_cache) do
    {
      valid_cert_url => instance_double("Paypal::Webhooks::X509Certificate",
        common_name:,
  ...
  describe "#verify!" do
    ...
    context "if #verify is false" do
      ...
      it "raises a WebhookEventVerificationFailed error" do
        expect { verify! }.to raise_error(Paypal::Webhooks::EventVerificationFailed)
      end
    end
